...
import com.nri.ejb.SecurityActionProcessorFacadeLocal;
import com.nri.ejb.SecurityActionProcessorFacadeLocalHome;
...
public class SecurityActionProcessorImpl implements SecurityActionProcessor {
	 ...
	 */
	/**
	 * Access (create) an instance of the SecurityActionProcessorFacadeLocal
	 * @returns a new Security session facade bean
	 */
	protected SecurityActionProcessorFacadeLocal getSecurityFacade() {
		try {
			return ((SecurityActionProcessorFacadeLocalHome) EJBClientHelper.getLocalHome("SecurityActionProcessorLocal")).create();
		} catch (Exception e) {
			AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught " + e);
			return null;
		}
	...
	/* (non-Javadoc)
	 * @see com.nri.model.SecurityActionProcessor#findWorkPositionByKey(Integer)
	 */
	...
	public void addCompany(Company newCompany) throws MappingException {
		...
		try {
			...
			try {
				...
				AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught in addCompany:" + e);
			}
		}
	}
	...
	public void addDivision(Division newDivision) throws MappingException {
		...
		try {
			...
			try {
				...
				AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught in addDivision:" + e);
			}
		}
	}
	...
	/* (non-Javadoc)
	 * @see com.nri.model.SecurityActionProcessor#findDivisions(java.lang.String, java.lang.Integer, java.lang.Boolean, java.lang.String)
	 */
