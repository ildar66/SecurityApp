...
public class _SecurityActionProcessorFacadeHome_Stub extends Stub implements SecurityActionProcessorFacadeHome {
    ...
    public SecurityActionProcessorFacade create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("create",com.nri.ejb.SecurityActionProcessorFacadeHome.class);
            if (so == null) {
                return create();
            }
            try {
                SecurityActionProcessorFacade result = ((com.nri.ejb.SecurityActionProcessorFacadeHome)so.servant).create();
