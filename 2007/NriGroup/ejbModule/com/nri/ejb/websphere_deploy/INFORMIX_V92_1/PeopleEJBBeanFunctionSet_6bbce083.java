...
/**
 * PeopleEJBBeanFunctionSet_6bbce083
 */
public class PeopleEJBBeanFunctionSet_6bbce083 extends com.ibm.ws.rsadapter.cci.WSResourceAdapterBase implements com.ibm.websphere.rsadapter.DataAccessFunctionSet {
	...
	public void Create(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			pstmt = prepareStatement(connection,"INSERT INTO informix.people (man, firstname, lastname, middlename, passportser, passportdate, passportwhom, isactive, tabnum) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public void Remove(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		PreparedStatement pstmt = null;
		try {
			pstmt = prepareStatement(connection,"DELETE FROM informix.people  WHERE man = ?");
	...
	public void Store(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		PreparedStatement pstmt = null;
		try {
			pstmt = prepareStatement(connection,"UPDATE informix.people  SET firstname = ?, lastname = ?, middlename = ?, passportser = ?, passportdate = ?, passportwhom = ?, isactive = ?, tabnum = ? WHERE man = ?");
	...
	public javax.resource.cci.Record FindByPrimaryKey(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		try {
			pstmt = prepareStatement(connection,"SELECT T1.man, T1.firstname, T1.lastname, T1.middlename, T1.passportser, T1.passportdate, T1.passportwhom, T1.isactive, T1.tabnum FROM informix.people  T1 WHERE T1.man = ?");
	...
	public javax.resource.cci.Record FindByPrimaryKeyForUpdate(IndexedRecord inputRecord, Object connection, WSInteractionSpec interactionSpec) throws DataStoreAdapterException {
		...
		ResultSet result=null;
		try {
			pstmt = prepareStatement(connection,"SELECT T1.man, T1.firstname, T1.lastname, T1.middlename, T1.passportser, T1.passportdate, T1.passportwhom, T1.isactive, T1.tabnum FROM informix.people  T1 WHERE T1.man = ? FOR UPDATE ");
	 ...
	 * PeopleEJBBeanFunctionSet_6bbce083
	 */
	public PeopleEJBBeanFunctionSet_6bbce083() {
