...
/**
 * SequenceBeanAdaptorBinding_61331c68
 */
public class SequenceBeanAdaptorBinding_61331c68 implements com.ibm.ws.ejbpersistence.beanextensions.BeanAdaptorBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.nri.sequence.ejb.websphere_deploy.INFORMIX_V94_1.SequenceBeanExtractor_61331c68
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.nri.sequence.ejb.websphere_deploy.INFORMIX_V94_1.SequenceBeanExtractor_61331c68();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.nri.sequence.ejb.websphere_deploy.INFORMIX_V94_1.SequenceBeanInjectorImpl_61331c68();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("Sequence", "Sequence1_Alias", "INFORMIX", "informix.sequences", "Sequence_Sequence1_Table");
		...
		primarykey[0] = "id";
		cat[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Sequence", "Sequence1_Table", null, fields, primarykey);

		//-------------------------------------------------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("id", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("value", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		primarykey = new String[1];
		primarykey[0] = "id";
		cat[2] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogType("Sequence", "Sequence_BO", "com.nri.sequence.ejb.SequenceBean", fields, primarykey);

		//-------------------------------------------------------------------------
		composedObjs = null;
		composedObjImpls = null;
		subhomes = null;
		cat[3] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogView("Sequence", "Sequence_Sequence_BO", "Sequence_Sequence1_Alias", composedObjs, composedObjImpls, 
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.nri.sequence.ejb.websphere_deploy.INFORMIX_V94_1.SequenceBeanFunctionSet_61331c68");
		...
		daSpec.setQueryScope(new String[]{"Sequence"});
		result.add(daSpec);
