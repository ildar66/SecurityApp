...
public class _SequenceSession_Stub extends Stub implements SequenceSession {
    ...
    public int getNextNumberInSequence(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    return getNextNumberInSequence(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("getNextNumberInSequence",com.nri.sequence.ejb.SequenceSession.class);
            if (so == null) {
                return getNextNumberInSequence(arg0);
            }
            try {
                return ((com.nri.sequence.ejb.SequenceSession)so.servant).getNextNumberInSequence(arg0);
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
