...
public class _SequenceSessionHome_Stub extends Stub implements SequenceSessionHome {
    ...
    public SequenceSession create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("create",com.nri.sequence.ejb.SequenceSessionHome.class);
            if (so == null) {
                return create();
            }
            try {
                SequenceSession result = ((com.nri.sequence.ejb.SequenceSessionHome)so.servant).create();
