...
public class OIDvalueBeanAdaptorBinding_9352f82e implements com.ibm.ws.ejbpersistence.beanextensions.BeanAdaptorBinding {
	...
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.god.oidgen.websphere_deploy.DB2UDBNT_V72_1.OIDvalueBeanExtractor_9352f82e
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.god.oidgen.websphere_deploy.DB2UDBNT_V72_1.OIDvalueBeanExtractor_9352f82e();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.god.oidgen.websphere_deploy.DB2UDBNT_V72_1.OIDvalueBeanInjectorImpl_9352f82e();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("OIDvalue", "OIDvalue1_Alias", "DB2NT", "OIDVALUE", "OIDvalue_OIDvalue1_Table");

		//-------------------------------------------------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("TYPE1", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 250, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("NEXTOID", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0);
		...
		"select t1.TYPE1,t1.NEXTOID from _this t1", 
		null, subhomes, 
		0, null);
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.god.oidgen.websphere_deploy.DB2UDBNT_V72_1.OIDvalueBeanFunctionSet_9352f82e");
