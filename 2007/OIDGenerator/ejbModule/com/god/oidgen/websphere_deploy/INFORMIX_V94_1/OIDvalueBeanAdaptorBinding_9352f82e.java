 ...
 */
public class OIDvalueBeanAdaptorBinding_9352f82e implements com.ibm.ws.ejbpersistence.beanextensions.BeanAdaptorBinding {
	/**
	 * getExtractor
	 */
	public com.ibm.ws.ejbpersistence.dataaccess.EJBExtractor getExtractor() {
		// extractor for com.god.oidgen.websphere_deploy.INFORMIX_V94_1.OIDvalueBeanExtractor_9352f82e
		com.ibm.ws.ejbpersistence.dataaccess.AbstractEJBExtractor extractor =  new com.god.oidgen.websphere_deploy.INFORMIX_V94_1.OIDvalueBeanExtractor_9352f82e();
	...
	public com.ibm.ws.ejbpersistence.beanextensions.EJBInjector getInjector() {
		return new com.god.oidgen.websphere_deploy.INFORMIX_V94_1.OIDvalueBeanInjectorImpl_9352f82e();
	}
	/**
	 * getAdapter
	 */
	...
	public Object[] getMetadata() {
		...
		//-------------------------------------------------------------------------
		cat[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalCatalogRDBAlias("OIDvalue", "OIDvalue1_Alias", "INFORMIX", "informix.sequences", "OIDvalue_OIDvalue1_Table");

		//-------------------------------------------------------------------------
		fields = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef[2];

		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("id", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 50, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("value", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, true, 0, -1, 0);
		...
		fields[0] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("type", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._CHARACTER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		fields[1] = new com.ibm.ObjectQuery.metadata.OSQLExternalColumnDef("nextOID", new String(), com.ibm.ObjectQuery.engine.OSQLSymbols._INTEGER, 0, com.ibm.ObjectQuery.engine.OSQLConstants.NO_TYPE, false, 0, -1, 0);
		primarykey = new String[1];
		primarykey[0] = "type";
	...
	public java.util.Collection createDataAccessSpecs() throws javax.resource.ResourceException {
		...
		iSpec.setFunctionSetName("com.god.oidgen.websphere_deploy.INFORMIX_V94_1.OIDvalueBeanFunctionSet_9352f82e");
