...
import com.nri.security.forms.WorkPositionLookupListForm;
 ...
 * @author
 */
public class WorkPositionLookupListAction extends Action {

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward = null;
		try {
			// Look at the ActionForm object
			WorkPositionLookupListForm aForm = (WorkPositionLookupListForm) form;
			...
			request.setAttribute(BeanKeys.WORK_POSITION_LOOKUP_LIST, list);
			forward = mapping.findForward("success");
		} catch (ModelException e) {
			AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught in WorkPositionLookupListAction.execute:" + e);
		}
		if (forward == null) {
	 ...
	 * @return
	 */
	protected Boolean buildIsActive(WorkPositionLookupListForm aForm) {
