...
import com.nri.security.forms.DivisionHierarchyListForm;
 ...
 * @author
 */
public class DivisionHierarchyListAction extends Action {

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward = null;
		try {
			// Look at the ActionForm object
			DivisionHierarchyListForm aForm = (DivisionHierarchyListForm) form;
			...
			AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught in DivisionHierarchyListAction.execute:" + e);
	 ...
	 */
	private void initList(HttpServletRequest request, DivisionHierarchyListForm aForm, SecurityActionProcessor processor, Integer encloserKey) throws ModelException {
		...
		request.setAttribute(BeanKeys.DIVISION_HIERARCHY_LIST, list);
	}
	 ...
	 */
	private void initHierarchyForEncloser(HttpServletRequest request, DivisionHierarchyListForm aForm, SecurityActionProcessor processor, Integer encloserKey)
	 ...
	 * @return
	 */
	protected Boolean buildIsActive(DivisionHierarchyListForm aForm) {
