...
import com.nri.security.forms.DivisionLookupListForm;
 ...
 * @author
 */
public class DivisionLookupListAction extends Action {

	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward = null;
		try {
			// Look at the ActionForm object
			DivisionLookupListForm aForm = (DivisionLookupListForm) form;
			...
			request.setAttribute(BeanKeys.DIVISION_LOOKUP_LIST, list);
			forward = mapping.findForward("success");
		} catch (ModelException e) {
			AppService.log(TraceCapable.ERROR_LEVEL, "Exception caught in DivisionLookupListAction.execute:" + e);
	 ...
	 * @return
	 */
	protected Boolean buildIsActive(DivisionLookupListForm aForm) {
