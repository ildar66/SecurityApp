...
<%
	if (request.getSession().getAttribute(com.nri.security.console.core.Constants.USER_KEY) != null) {
		request.getSession().removeAttribute(com.nri.security.console.core.Constants.USER_KEY);
		request.getSession().removeAttribute(com.nri.security.console.core.Constants.CURRENTCELLCTXT_KEY);
		request.getSession().removeAttribute(com.nri.security.console.core.Constants.CURRENTNODECTXT_KEY);
	}
%>
