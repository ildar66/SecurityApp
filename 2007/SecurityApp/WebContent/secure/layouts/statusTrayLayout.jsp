...
<%@ page import="com.nri.security.console.core.bean.StatusBean" %>
<%@ page import="java.util.*" %>
<%@ page import="com.nri.security.console.core.bean.UserPreferenceBean" %>
<%@ page import="com.nri.security.console.core.*" %>
...
<jsp:useBean id="statusBean" class="com.nri.security.console.core.bean.StatusBean" scope="session"/>
    ...
    <tr> 
      <td class="layout-manager" id="notabs"> 
        ...
        <table border="0" cellpadding="2" cellspacing="0" valign="top" width="100%" summary="Framing Table" >
          <tr> 
            <td class="was-message-item" nowrap><%--bean:message key="statustray.title" /--%>NRI Status
