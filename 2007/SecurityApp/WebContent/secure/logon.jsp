...
<% //if (SecurityContext.isSecurityEnabled()) {
      ((HttpServletResponse)pageContext.getResponse()).sendRedirect(request.getContextPath() + "/logon.do?action=secure");
   //}
%>
...
<html:form action="logon.do" name="logonForm" focus="username" type="com.ibm.ws.console.core.form.LogonForm">
