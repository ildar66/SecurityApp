...
document.write("<scr"+"ipt type='text/javascript' src='/SecurityApp/calendar/"+gTheme[1]+".js'></scr"+"ipt>");
document.write("<scr"+"ipt type='text/javascript' src='/SecurityApp/calendar/"+(gTheme[4]?gTheme[4]:"plugins.js")+"'></scr"+"ipt>");
</script>
<script type='text/javascript'>
...
with (document) {
	if (gTheme[2]&&!_isAS) write("<scr"+"ipt type='text/javascript' src='/SecurityApp/calendar/"+gTheme[2]+"'></scr"+"ipt>");
	write("<lin"+"k rel='stylesheet' type='text/css' href='/SecurityApp/calendar/"+gTheme[1]+".css'>");
}
</script>
</head>
